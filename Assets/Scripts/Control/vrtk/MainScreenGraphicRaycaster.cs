namespace UnityEngine.UI {
    ...
    public class MainScreenGraphicRaycaster : BaseRaycaster {
        ...
        public override Camera eventCamera {
            get {
                if (canvas.renderMode == RenderMode.ScreenSpaceOverlay
                    ...
                    return null;
                if (_cam == null)
                    _cam = GameObject.FindGameObjectWithTag("MainScreenCamera")?.GetComponent<Camera>();
                return _cam;
            }
        }
        ...
        [SerializeField]
        protected LayerMask m_BlockingMask = ~Physics.IgnoreRaycastLayer;

        private Canvas m_Canvas;

        protected MainScreenGraphicRaycaster() { }
