...
public static class NormalSolver {
    public static void RecalculateNormalsBetter(this SerialMesh mesh, float angle) {
        ...
        var triNormals = new Vector3[1][];

        var dictionary = new Dictionary<VertexKey, List<VertexEntry>>(vertices.Length);

        for (var subMeshIndex = 0; subMeshIndex < 1; ++subMeshIndex) {
    ...
    public static void RecalculateNormalsBetter(this Mesh mesh, float angle) {
        var cosineThreshold = Mathf.Cos(angle * Mathf.Deg2Rad);
