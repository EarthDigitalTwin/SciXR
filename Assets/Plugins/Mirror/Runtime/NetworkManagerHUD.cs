    ...
    public class NetworkManagerHUD : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            if (!NetworkClient.isConnected && !NetworkServer.active)
            {
                ...
                {
                    // Connecting
                    GUILayout.Label("Connecting to " + manager.networkAddress + "..", textColor);
            ...
            else
            {
                ...
                {
                    GUILayout.Label("Server: active. Transport: " + Transport.activeTransport, textColor);
                }
                if (NetworkClient.isConnected)
                {
                    GUILayout.Label("Client: address=" + manager.networkAddress, textColor);
                }
            }
