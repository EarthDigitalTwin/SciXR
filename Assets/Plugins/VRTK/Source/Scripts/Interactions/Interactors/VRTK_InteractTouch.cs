...
namespace VRTK
{
    ...
    public class VRTK_InteractTouch : MonoBehaviour
    {
        ...
        protected VRTK_InteractableObject overrideTouched;
        ...
        protected virtual void OnTriggerEnter(Collider collider)
        {
            ...
            if (touchedObject != null && colliderInteractableObject != null && touchedObject != colliderInteractableObject && touchedObjectScript != null && !touchedObjectScript.IsGrabbed())
            {
                ...
                if (collidedObjectScript.priority >= touchedObjectScript.priority) {
                    overrideTouched = collidedObjectScript;
                    ForceStopTouching();
        ...
        protected virtual void OnTriggerStay(Collider collider)
        {
            ...
            {
                VRTK_InteractableObject touchedObjectScript = colliderInteractableObject.GetComponent<VRTK_InteractableObject>();
                if(overrideTouched != null) {
                    touchedObjectScript = overrideTouched;
                    overrideTouched = null;
                }
                ...
                touchedObject = touchedObjectScript.gameObject;
