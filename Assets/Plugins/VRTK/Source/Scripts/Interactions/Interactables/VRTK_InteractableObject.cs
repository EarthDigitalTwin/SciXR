...
namespace VRTK
{
    ...
    public class VRTK_InteractableObject : MonoBehaviour
    {
        ...
        [Tooltip("Parent to always default to when unsnapped from a Drop Zone")]
        ...
        [Tooltip("Determines Priority of Touch (and grab) with other InteractableObjects.")]
...
#pragma warning restore 0618
        ...
        protected virtual void OnEnable()
        {
            ...
            forcedDropped = false;
            startDisabled = false;
            //if (storedSnapDropZone != null)
            //        ToggleSnapDropZone(storedSnapDropZone, true);
